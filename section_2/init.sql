...
CREATE INDEX "IDX_TRANSACTIONS_MEMBERSHIP_ID" ON "ASSESSMENT"."TB_TRANSACTION"("MEMBERSHIP_ID_TXT");
...
CREATE INDEX "IDX_TRANSACTION_ITEMS_TRANSACTION_ID" ON "ASSESSMENT"."TB_TRANSACTION_ITEM_MAPPING"("TRANSACTION_ID_NO");
CREATE INDEX "IDX_TRANSACTION_ITEMS_ITEM_ID" ON "ASSESSMENT"."TB_TRANSACTION_ITEM_MAPPING"("ITEM_ID_NO");
...
COMMENT ON COLUMN "ASSESSMENT"."TB_REJECTED_APPLICATION"."FULL_NAME" IS 'Original full name string submitted by applicant (may be empty or invalid).';
...
("FULL_NAME", "EMAIL_ADDR", "MOBILE_NO", "BIRTH_DT", "REJECT_REASON_TXT", "CREATED_BY_ID_NO", "UPDATED_BY_ID_NO")
VALUES
